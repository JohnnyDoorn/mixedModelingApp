...
Model 2)  Fixed effect $\nu$ of condition, which is the same for all participants. The term $x_j$  indicates the specific condition (i.e., $x_j= -1/2, 1/2$ if $J = 2$), which ensures the sums-to-zero constraint.
\[
